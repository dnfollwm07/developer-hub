...
export default async function Page({ params }: PageProps) {
  try {
    ...
    // 调试信息：记录路径信息
    console.log('[Personal Page] Loading content:', {
      urlPath,
      basePath,
      slug,
      language,
    ...
    if (result) {
      console.log('[Personal Page] Content loaded successfully:', {
    ...
    console.log('[Personal Page] Content not found, checking children:', {
      urlPath,
    ...
    console.error('[Personal Page] Content not found and no children:', {
      urlPath,
      basePath,
      slug,
      language,
